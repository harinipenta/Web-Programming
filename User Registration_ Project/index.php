...
<tr>
<td>Email</td>
<td><input type="text" class="demoInputBox" placeholder="Email" name="userEmail" value="<?php if(isset($_POST['userEmail'])) echo $_POST['userEmail']; ?>"></td>
</tr>
<tr>
<td>Gender</td>
...
<a href="disply_records.php"> <input type="button" name="view records" value="View Records" class="btnRegister"> </a></td>
</tr>
