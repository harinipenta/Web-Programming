...
class GameOfLife extends React.Component{
	constructor( props ){
		...
		this.oneIncrement = this.oneIncrement.bind(this);
		this.multiIncrement = this.multiIncrement.bind(this);
	...
	//change code
	for(var i=0;i<23;i++)
	//this.setState( prevState => ( {  cellsData: GameTools.getBoardAfterEvaluation( prevState.cellsData ), generations: prevState.generations + 23 } ) );
	this.isRunning = false;
	}
	clearBoard( ){
  ...
  <div>
    <Header />
    <ControlBar run={this.onRunGameClick} pause={this.pauseGame} oneIncrement={this.oneIncrement} multiIncrement={this.multiIncrement} clear={this.clearBoard} />
